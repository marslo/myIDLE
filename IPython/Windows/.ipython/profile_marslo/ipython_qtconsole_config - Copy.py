...
# load_subconfig('ipython_config.py', profile='marslo')



#------------------------------------------------------------------------------
# Customized profile by Marslo
#------------------------------------------------------------------------------

c.IPythonWidget.in_prompt = '<span class="in-prompt-number">%i</span> >> '
c.IPythonWidget.out = '<span class="in-prompt-number">%i</span> >> '
...
c.IPythonQtConsoleApp.profile = u'marslo'

c.InlineBackend.rc = {'font.size': 12, 'savefig.dpi': 72, 'figure.figsize': (6.0, 4.0), 'figure.subplot.bottom': 0.125}

# c.ZMQInteractiveShell.prompt_in1 = '\\# >> '
# c.ZMQInteractiveShell.prompt_out = '\\# >> '
...
# variable IPYTHONDIR.
# c.IPythonQtConsoleApp.ipython_dir = u'C:\\Users\\jiaoolii\\.ipython'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'C:\\Users\\jiaoolii\\.ipython'
